 ...
 * @version 2.0
 */
public abstract class StateExpandable extends State implements Cloneable {
     ...
     */
    public StateExpandable(int[] vertices, int[] expandable, int[] unexpandable) {
     ...
     * choice.
     */
    public abstract StateExpandable expand(Graph g, int expandIndex);
