 ...
 * root node of an occurrence and all occurrences with that node as the root are
 * found by that thread. This is balanced as long the workload per node is
...
public class MultiBackTrackEnumerator implements PrimaryEnumerator {
     ...
     */
    public MultiBackTrackEnumerator(Graph g, int threadCount) {
     ...
     * {@link #enumerate(Graph, int, int, boolean)}.
     */
    public MultiBackTrackEnumerator(Graph g) {
